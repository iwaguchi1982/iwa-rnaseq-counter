...
def main():
    ...
    p_run.add_argument("--quantifier", type=str, default="salmon", help="Quantifier backend: salmon, star, hisat2, kallisto")
    ...
    p_batch.add_argument("--quantifier", type=str, default="salmon", help="Quantifier backend: salmon, star, hisat2, kallisto")
